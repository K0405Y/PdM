...
CREATE TABLE IF NOT EXISTS maintenance_events.turbine_maintenance (
...
CREATE INDEX IF NOT EXISTS idx_gt_maint_turbine ON maintenance_events.turbine_maintenance(turbine_id);
CREATE INDEX IF NOT EXISTS idx_gt_maint_time ON maintenance_events.turbine_maintenance(start_time DESC);
