...
INSERT INTO failure_events.failure_modes (equipment_type, mode_code, description) VALUES
    ...
    ('pump', 'F_BEARING_OVERTEMP', 'Bearing Overtemperature - Excessive friction or cooling failure'),
    ('pump', 'F_HIGH_VIBRATION', 'High Vibration Trip - Mechanical instability'),
    ('pump', 'F_CAVITATION', 'Severe Cavitation - NPSH margin critical'),
    ('pump', 'F_MOTOR_OVERLOAD', 'Motor Overload - Excessive current draw')
